...
COPY crates ./crates
RUN --mount=type=cache,id=s/9bc5d72a-0a8e-4723-ba76-a4ed3bd7ea09-/usr/local/cargo/registry,target=/usr/local/cargo/registry \
    --mount=type=cache,id=s/9bc5d72a-0a8e-4723-ba76-a4ed3bd7ea09-/src/target,target=/src/target \
...
RUN --mount=type=cache,id=s/9bc5d72a-0a8e-4723-ba76-a4ed3bd7ea09-/root/.bun/install/cache,target=/root/.bun/install/cache \
...
RUN --mount=type=cache,id=s/9bc5d72a-0a8e-4723-ba76-a4ed3bd7ea09-/root/.cache/uv,target=/root/.cache/uv \
